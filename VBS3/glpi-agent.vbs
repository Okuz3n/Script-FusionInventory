...
Option Explicit
Dim Force, Verbose
Dim Setup, SetupArchitecture, SetupLocation, SetupOptions, SetupVersion, SetupTag, Option1, Option2

SetupTag = InputBox("Nom du Tag ?", "question", "defaut")
...
Option1 = "/acceptlicense /runnow /execmode=service /add-firewall-exception /tag="& SetupTag
Option2 = "/server='https://support.kamitec.com/glpi/plugins/fusioninventory/' /S"
SetupOptions = Option1+Option2
' Setup
'    The installer file name. You should not have to modify this variable ever.
'
Setup = "fusioninventory-agent_windows-x64_2.6.exe"
